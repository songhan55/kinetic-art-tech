...
* **1단계: 평화 / 근접 진정 (`0 ~ 30 점`)** $\rightarrow$ **에메랄드 틸 그린 (`#10b981`)**
* **2단계: 일상 트렌드 (`30 ~ 65 점`, 현재 39.5점/42점 구간)** $\rightarrow$ **따뜻한 샴페인 앰버 골드 (`#cba258`)**
* **3단계: 긴장 고조 (`65 ~ 85 점`)** $\rightarrow$ **타오르는 탠저린 오렌지 (`#f97316`)**
* **4단계: 극단적 전쟁 위기 (`85 ~ 100 점`, 2022 러-우 전쟁 발발 직전 98.4점)** $\rightarrow$ **핏빛 크림슨 루비 레드 (`#ef4444`)**
